...
bool TextureShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	WCHAR vs[] = L"../Engine/texture.vs";
	WCHAR ps[] = L"../Engine/texture.ps";
...
bool TextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DX11CompileFromFile(vsFilename, nullptr, nullptr, "TextureVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS,
	...
	result = D3DX11CompileFromFile(psFilename, nullptr, nullptr, "TexturePixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS,
