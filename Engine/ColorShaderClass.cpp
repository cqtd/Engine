...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	WCHAR vs[] = L"../Engine/color.vs";
	WCHAR ps[] = L"../Engine/color.ps";
...
bool ColorShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX world, D3DXMATRIX view,
...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	if (FAILED(result))
	{
		...
		{
			MessageBox(hwnd, vsFilename, L"Missing Vertex Shader", MB_OK);
		}
	...
	if (FAILED(result))
	{
		...
		{
			MessageBox(hwnd, psFilename, L"Missing Pixel Shader", MB_OK);
		}
...
bool ColorShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX world, D3DXMATRIX view,
                                           D3DXMATRIX projection)
{
	HRESULT result;
